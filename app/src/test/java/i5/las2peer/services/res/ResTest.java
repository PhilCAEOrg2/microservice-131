...
public class ResTest {
  ...
  public void testTest12() {
    ...
    try {
      ...
      ClientResponse result = c.sendRequest("GET", mainPath + "/req1", """
""");
  ...
  /**
   * 
   * Second Test for the Test2 method.
   * 
   */
  @Test
...
""");
      ...
      Assert.assertEquals("Status code equals 201 [441478]", result.getHttpCode(), 201);
